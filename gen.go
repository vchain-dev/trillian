...
//go:generate mockgen -package tmock -destination testonly/tmock/mock_log_server.go  github.com/vchain-dev/trillian TrillianLogServer
//go:generate mockgen -package tmock -destination testonly/tmock/mock_map_server.go  github.com/vchain-dev/trillian TrillianMapServer
//go:generate mockgen -package tmock -destination testonly/tmock/mock_admin_server.go github.com/vchain-dev/trillian TrillianAdminServer
